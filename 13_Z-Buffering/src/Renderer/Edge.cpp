...
void Edge::set(VertexInternal& vVertexStart, VertexInternal& vVertexEnd)
{
	...
	SET_INTERNAL_VARYING_START(EVaryingsInternal::ONEOVERZ_VARYING, (1.0f / vVertexStart.m_vVertPosition.w))
	SET_INTERNAL_VARYING_START(EVaryingsInternal::DEPTH_VARYING,	vVertexStart.m_vVertPosition.z)
	...
	SET_INTERNAL_VARYING_END(EVaryingsInternal::ONEOVERZ_VARYING,	(1.0f / vVertexEnd.m_vVertPosition.w))
	SET_INTERNAL_VARYING_END(EVaryingsInternal::DEPTH_VARYING,		vVertexEnd.m_vVertPosition.z)
	...
	// Init Varyings
	{
		...
		SET_INTERNAL_VARYING(EVaryingsInternal::ONEOVERZ_VARYING,	LERP(GET_INTERNAL_VARYING_START(EVaryingsInternal::ONEOVERZ_VARYING), GET_INTERNAL_VARYING_END(EVaryingsInternal::ONEOVERZ_VARYING), m_fYLerpAmount))
		SET_INTERNAL_VARYING(EVaryingsInternal::DEPTH_VARYING,		LERP(GET_INTERNAL_VARYING_START(EVaryingsInternal::DEPTH_VARYING), GET_INTERNAL_VARYING_END(EVaryingsInternal::DEPTH_VARYING), m_fYLerpAmount))
